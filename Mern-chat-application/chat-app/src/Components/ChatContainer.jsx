...
export const ChatContainer = ({selectedUser, setSelectedUser}) => {
    ...
    return selectedUser ? (
        ...
        <div className="h-full flex overflow-scroll flex-col relative backdrop-blur-lg">
            {/* ------------- Header ------------- */}
          ...
          {/* ------------- Chat Area ------------- */}
          <div className="flex flex-col flex-1 overflow-y-scroll h-[calc(100% - 120xp)] overflow-y-scroll p-3 pb-6 gap-3">
            {
